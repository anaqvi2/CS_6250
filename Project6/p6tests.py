...
def main():
    ...
    test_nc_tcp(net, "server2", 1723)
    print "**These should succeed"
    test_nc_tcp(net, "server2", 1722)

    print "**\n\npart 2"
    print "**These should fail"
    test_iperf_udp(net, "server1", "e1", 22)
    test_iperf_udp(net, "server1", "e2", 22)
    test_iperf_udp(net, "server1", "e3", 22)
    print "**These should succeed"
    test_iperf_udp(net, "server1", "e2", 23)
    test_iperf_udp(net, "server1", "e1", 23)
    test_iperf_udp(net, "server1", "e3", 23)

    print "**\n\npart 3"
    print "**These should fail"
    test_iperf_udp(net, "e1", "server1", 123)
    test_iperf_udp(net, "e1", "server2", 123)
    test_iperf_udp(net, "e1", "server1", 53)
    test_iperf_udp(net, "e1", "server2", 53)
    print "**These should succeed"
    test_iperf_udp(net, "e1", "server1", 13)
    test_iperf_udp(net, "e1", "server2", 13)
    test_iperf_udp(net, "e1", "server1", 5)
    test_iperf_udp(net, "e1", "server2", 5)
    test_iperf_udp(net, "e1", "server3", 123)
    test_iperf_udp(net, "e1", "server3", 53)

    print "**\n\npart 5"
    print "**These should fail only from e1 and from mobile1 (because of rule 6)"
    test_nc_tcp(net, "e3", 9950)
    test_nc_tcp(net, "e3", 9951)
    test_nc_tcp(net, "e3", 9952)


    print "**\n\npart 6"
    print "**These should fail"
    test_iperf_udp(net, "mobile1", "e1", 5883)
    test_iperf_udp(net, "mobile1", "e2", 5883)
    test_iperf_udp(net, "mobile1", "e3", 5883)
    test_iperf_udp(net, "mobile1", "e1", 588)
    test_iperf_udp(net, "mobile1", "e2", 588)
    test_iperf_udp(net, "mobile1", "e3", 588)
    print "**These should fail only from mobile 1"
    test_nc_tcp(net, "e1", 5883)
    test_nc_tcp(net, "e2", 5883)
    test_nc_tcp(net, "e3", 5883)
    test_nc_tcp(net, "e1", 588)
    test_nc_tcp(net, "e2", 588)
    test_nc_tcp(net, "e3", 588)
    print "**These should succeed"
    test_iperf_udp(net, "w1", "e1", 5883)
    test_iperf_udp(net, "w1", "e2", 5883)
    test_iperf_udp(net, "w1", "e3", 5883)
    test_iperf_udp(net, "w1", "e1", 588)
    test_iperf_udp(net, "w1", "e2", 588)
    test_iperf_udp(net, "w1", "e3", 588)
